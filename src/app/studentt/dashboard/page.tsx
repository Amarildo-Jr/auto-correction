                ...
                <div className="grid gap-4">
                  ...
                  {upcomingExams.length > 0 && (
                    <div className="flex items-start gap-4 p-4 bg-yellow-50 rounded-lg">
                      ...
                      <div className="grid gap-1 text-sm">
                        <div className="font-medium">Próxima Prova Agendada</div>
                        <div className="text-muted-foreground">
                          Você tem {upcomingExams.length} prova(s) agendada(s) para as próximas semanas.
                  ...
                  <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
                    ...
                    <div className="grid gap-1 text-sm">
                      <div className="font-medium">Dicas para o Sucesso</div>
                      <div className="text-muted-foreground">
                        Lembre-se de verificar regularmente suas turmas e provas.
